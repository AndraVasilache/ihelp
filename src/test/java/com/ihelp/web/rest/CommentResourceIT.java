...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().date(DEFAULT_DATE).content(DEFAULT_CONTENT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().date(UPDATED_DATE).content(UPDATED_CONTENT);
        return comment;
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.date(UPDATED_DATE).content(UPDATED_CONTENT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.date(UPDATED_DATE).content(UPDATED_CONTENT);
